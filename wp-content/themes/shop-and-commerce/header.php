	...
	<div class="clear"></div>
		<?php if ( is_front_page() or is_home() ) { ?>
			...
			<?php if (!get_theme_mod('hide_img_1')) : ?>
					<a href="product/ipad-32gb-space-gray/">
						<div class="sp-image">
							<div class="sp-overlay"></div>
							<div class="sp-title"><?php if (!get_theme_mod('shop_and_commerce_title1')) : echo "IPAD 32GB White"; else : echo esc_attr(get_theme_mod('shop_and_commerce_title1')); endif; ?></div>
							<div class="sp-description"><?php if (!get_theme_mod('shop_and_commerce_text1')) : echo "$9999.00"; else : echo esc_attr(get_theme_mod('shop_and_commerce_text1')); endif; ?></div>
							<img src="<?php echo get_template_directory_uri() .'/images/product5.jpg'; ?>" alt="img-1" />
						</div>
					</a>				
			<?php else : ?>
			...
			<?php if (!get_theme_mod('hide_img_2')) : ?>
					<a href="product/3ds-pokemon-moon/">
						<div class="sp-image">
							<div class="sp-overlay"></div>
							<div class="sp-title"><?php if (!get_theme_mod('shop_and_commerce_title2')) : echo "Pokemon Sun and Moon"; else : echo esc_attr(get_theme_mod('shop_and_commerce_title2')); endif; ?></div>
							<div class="sp-description"><?php if (!get_theme_mod('shop_and_commerce_text2')) : echo "$549.00"; else : echo esc_attr(get_theme_mod('shop_and_commerce_text2')); endif; ?></div>
							<img src="<?php echo get_template_directory_uri() .'/images/product6.jpg'; ?>" alt="img-2" />
						</div>
					</a>				
			<?php else : ?>
			...
			<?php if (!get_theme_mod('hide_img_3')) : ?>
					<a href="product/audifonos-sennheiser-hd-4-30i-black/">
						<div class="sp-image">
							<div class="sp-overlay"></div>
							<div class="sp-title"><?php if (!get_theme_mod('shop_and_commerce_title3')) : echo "Sennheiser HD Headphones"; else : echo esc_attr(get_theme_mod('shop_and_commerce_title3')); endif; ?></div>
							<div class="sp-description"><?php if (!get_theme_mod('shop_and_commerce_text3')) : echo "$1749.00"; else : echo esc_attr(get_theme_mod('shop_and_commerce_text3')); endif; ?></div>
							<img src="<?php echo get_template_directory_uri() .'/images/product7.jpg'; ?>" alt="img-3" />
						</div>
					</a>				
			<?php else : ?>
			...
			<?php endif; endif; ?>
				...
				<?php if (!get_theme_mod('hide_img_4')) : ?>
					<a href="product/laptop-asus-vivobook-max-15-6-core-i5-7200u-8gb-1t-chocolate/">
						<div class="sp-image">
							<div class="sp-overlay"></div>
							<div class="sp-title"><?php if (!get_theme_mod('shop_and_commerce_title4')) : echo "Laptop Asus i5-7200U"; else : echo esc_attr(get_theme_mod('shop_and_commerce_title4')); endif; ?></div>
							<div class="sp-description"><?php if (!get_theme_mod('shop_and_commerce_text4')) : echo "$11,999.00"; else : echo esc_attr(get_theme_mod('shop_and_commerce_text4')); endif; ?></div>
							<img src="<?php echo get_template_directory_uri() .'/images/product8.jpg'; ?>" alt="img-4" />
						</div>
					</a>				
			<?php else : ?>
			<?php if(get_theme_mod('shop_and_commerce_img2') ) : ?>
